...
public class MyDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getModelAccess().getPragmasAssignment_1(), "rule__Model__PragmasAssignment_1");
			builder.put(grammarAccess.getModelAccess().getNameAssignment_3(), "rule__Model__NameAssignment_3");
			builder.put(grammarAccess.getModelAccess().getImportsAssignment_4(), "rule__Model__ImportsAssignment_4");
			builder.put(grammarAccess.getModelAccess().getBlockAssignment_5(), "rule__Model__BlockAssignment_5");
