 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.S_Try#getCatch <em>Catch</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getS_Try()
 * @model
 * @generated
 */
public interface S_Try extends Statement
{
   ...
   * @see #setCatch(Block)
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getS_Try_Catch()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myDsl.S_Try#getCatch <em>Catch</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
